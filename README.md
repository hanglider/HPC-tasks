...
!["Пример запуска"](MPI/results/image.png "Пример запуска")
...
![](MPI/results/task2_dot_efficiency.png " ")
![](MPI/results/task2_dot_speedup.png " ")
![](MPI/results/task2_dot_time.png " ")

OpenMPß

![](OpenMP/results/task2_dot_efficiency.png " ")
![](OpenMP/results/task2_dot_speedup.png " ")
![](OpenMP/results/task2_dot_time.png " ")

Время выполнения уменьшается почти обратно пропорционально числу потоков до 8, затем замедление.
Ускорение при 2–4 потоках рост близок к линейному, при дальнейшем увеличении — насыщение.
Эффективность >1 для N=10⁷ при малом числе потоков (эффект кэширования), затем плавное снижение.
